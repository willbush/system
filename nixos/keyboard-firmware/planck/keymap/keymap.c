...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, NUM,     SUPER,   KC_LALT, LOWER,   HYPER,   KC_SPC,  RAISE,   KC_RALT, KC_RGUI, _______, _______
  ),
  ...
  [_LOWER] = LAYOUT_planck_grid(
    ...
    KC_TILD, KC_AT,   KC_LPRN, KC_PLUS, KC_MINS, KC_RPRN, KC_LCBR, KC_ASTR, KC_HASH, KC_RCBR, KC_PIPE, KC_DEL,
  ...
  [_RAISE] = LAYOUT_planck_grid(
    _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______,
    KC_GRV,  KC_EXLM, KC_LBRC, KC_EQL,  KC_UNDS, KC_RBRC, KC_CIRC, KC_PERC, KC_AMPR, KC_DLR,  KC_BSLS, KC_DEL,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
  ),
  [_HYPER] = LAYOUT_planck_grid(
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______,
    _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_F11,  _______,
