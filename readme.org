...
**** Row 0
  ...
  | shift   |       | A append eol | R rpl mode  | S insert bol    | T back till    | G eof / goto ln |
  | lower   |       | ~            | (           | !               | =              | )               |
  | raise   |       | ` goto mk    | [           | +               | -              | ]               |
  | ======= | ===== | ============ | =========== | =============== | ============== | =============== |
...
*** Right half
  ...
  |---------+------------+---------------+-------------+-----------+---------------+---------------|
  | default | j          | l end word    | u undo      | y yank    | ; repeat      | Bksp          |
  | shift   | J join ln  | L end WORD    | U redo      | Y tank ln | : ex cmd line |               |
  | lower   | {          | %             | &           | }         | \vert         | Del           |
  | raise   | ^          | *             | #           | $         | \             | Del           |
  | ======= | ========== | ============= | =========== | ========= | ============= | ============= |
  | default | m left     | n down        | e up        | i right   | o open below  | ' goto mk bol |
  | shift   | M hard bol | N scroll down | E scroll up | I eol     | O open above  | " reg spec    |
  | Alt     | scrn mid   | scrn bot      | scrn top    |           |               |               |
  | raise   |            | @             |             |           |               |               |
  | ======= | ========== | ============= | =========== | ========= | ============= | ============= |
  | default | k set mk   | h next        | ,           | .         | / find        | RET/S         |
