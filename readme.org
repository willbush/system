...
** A rough estimation of frequency
 ...
 | n next          | ? rev find   | C-d scroll down | E end WORD    | ! ext filter |
...
*** Things of note:
    ...
    - I never use substitute and it's on a home key

    - I hardly use marks, but perhaps that is in part a bad habit.
...
*** Right half
  ...
  | shift   | J join ln    | L end WORD    | U redo        | Y yank ln    | : ex cmd line |        |
  ...
  | Alt     | M-m scrn mid | M-n scrn bot  | M-e scrn top  |              |               |        |
  | raise   |              | @ play macro  |               |              |               |        |
  | ======= | ==========   | ============= | ===========   | =========    | ============= | =====  |
