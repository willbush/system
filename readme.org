...
- *keyboard firmware* code managed by Nix and the [[file:configs/keyboard-firmware/readme.org][readme]] that goes into depth on
  my key layout and customized Evil / Vim keybindings.

- *Xmonad* configuration code which is symlinked by home-manager. See its [[file:configs/xmonad/readme.org][readme]]
