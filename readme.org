...
*** Things of note:
    ...
    - I really ought to make use of ~,~ more to reverse a f/t/F/T search, but I
      haven't made a habit out of it.
...
**** Visual Mode key remap
     ...
     addition, notice the finger rolling action from ~r~ to ~f~ / ~t~ to
     visual/range select till some character. If I left it where it was it would
     have been in a worse position compared to Qwerty, but now it's better.
